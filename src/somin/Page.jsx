  ...
  return (
    <div className={styles["somin-page"]}>
      <Routes>
        ...
        <Route path="week7" element={<Week7Page membersList={membersList} setMembersList={setMembersList} />} />
        <Route path="week8" element={<Week8Page />} />
        <Route path="week9" element={<Week9Page />} />
        <Route path="week10" element={<Week10Page />} />
        <Route path="week7/lions/:id" element={<DetailPage membersList={membersList} />} />
      </Routes>
    </div>
  );
}
