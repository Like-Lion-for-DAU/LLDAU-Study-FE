      ...
      {showForm && (
        <form className={styles.formContainer} onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            ...
            <input name="tech" type="text" placeholder="예: JavaScript, React, HTML/CSS" />
          </div>

          <div className={styles.formGroup}>
            <label>한 줄 소개 (요약 카드)</label>
            <input name="intro" type="text" placeholder="예: 3주차 DOM 조작 연습 중!" />
          </div>

          <div className={styles.formGroup}>
            <label>자기소개 (상세 카드)</label>
            <textarea name="description" placeholder="예: HTML/CSS로 구조를 만들고, JS로 데이터를 바꾸면..." />
          </div>
          ...
          <div className={styles.formRow}>
            <div className={styles.formGroup}>
              ...
              <input name="email" type="email" placeholder="예: lion@example.com" />
            </div>
            <div className={styles.formGroup}>
              <label>Phone</label>
          ...
          <div className={styles.formGroup}>
            <label>Website</label>
            <input name="website" type="url" placeholder="예: https://example.com" />
          </div>

          <div className={styles.formGroup}>
            <label>한 마디</label>
            <input name="comment" type="text" placeholder="예: 데이터 바꾸면 화면도 바뀐다!" />
          </div>
