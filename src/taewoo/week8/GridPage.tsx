...
export default function GridPage() {
  ...
  const nextIdRef = useRef<number>(memberList.length + 1);
      ...
      <div className={styles["bannerSection"]}>
        ...
        <div className={styles["sortLabelRow"]}>
          ...
          <select
            ...
            value={sortPart}
            onChange={(e) => setSortPart(e.target.value)}
          >
          ...
          <div className={styles["pushLionContent"]} onClick={(e) => e.stopPropagation()}>
            <form className={styles["pushLionGrid"]} onSubmit={handleAddSubmit}>
              ...
              <div className={`${styles["pushLionRow"]} ${styles["fullWidth"]}`}>
                ...
                {warnFormat("website") && (
                  <span className={styles["inputWarning"]}>
                    <b>!</b> http:// 또는 https:// 로 시작하는 URL이어야 합니다 <b>!</b>
                  </span>
                )}
              </div>
            ...
            {!selected.contact && !selected.skills && !selected.last ? (
              ...
              <>
                ...
                {selected.introduce?.map((text, i) => (
                  <p key={`${selected.id}-intro-${i}`} className={styles["introduceMyself"]}>
                    {text}
                  </p>
                ))}
                  ...
                  <>
                    ...
                    <ul>
                      {selected.contact.email && (
                        <li className={styles["listStyle"]}>Email: {selected.contact.email}</li>
                      )}
                      {selected.contact.phone && (
                        <li className={styles["listStyle"]}>Phone: {selected.contact.phone}</li>
                      )}
